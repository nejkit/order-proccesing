...
func (LockBalanceStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_balances_Common_proto_enumTypes[0].Descriptor()
}

func (LockBalanceStatus) Type() protoreflect.EnumType {
	return &file_balances_Common_proto_enumTypes[0]
}
...
func (x *LockBalanceRequest) Reset() {
	*x = LockBalanceRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_balances_Common_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LockBalanceRequest) Descriptor() ([]byte, []int) {
	return file_balances_Common_proto_rawDescGZIP(), []int{4}
}
...
func (x *LockBalanceResponse) Reset() {
	*x = LockBalanceResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_balances_Common_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LockBalanceResponse) Descriptor() ([]byte, []int) {
	return file_balances_Common_proto_rawDescGZIP(), []int{5}
}
...
func (x *LockBalanceResponse) GetErrorMessage() string {
	if x != nil {
...
var file_balances_Common_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x6f, 0x52, 0x0a, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x22,
	0x72, 0x0a, 0x12, 0x4c, 0x6f, 0x63, 0x6b, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x52, 0x65,
	...
	0x75, 0x6e, 0x74, 0x22, 0x74, 0x0a, 0x13, 0x4c, 0x6f, 0x63, 0x6b, 0x42, 0x61, 0x6c, 0x61, 0x6e,
	...
	0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x12, 0x2e, 0x4c, 0x6f, 0x63, 0x6b,
	0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x05, 0x73,
	...
	0x6f, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2a, 0x4d, 0x0a, 0x11, 0x4c, 0x6f, 0x63,
	...
	0x4a, 0x45, 0x43, 0x54, 0x45, 0x44, 0x10, 0x03, 0x42, 0x0b, 0x5a, 0x09, 0x2f, 0x62, 0x61, 0x6c,
...
var file_balances_Common_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_balances_Common_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_balances_Common_proto_goTypes = []interface{}{
	(LockBalanceStatus)(0),        // 0: LockBalanceStatus
	(*BalanceInfo)(nil),           // 1: BalanceInfo
	(*WalletInfo)(nil),            // 2: WalletInfo
	(*GetWalletInfoRequest)(nil),  // 3: GetWalletInfoRequest
	(*GetWalletInfoResponse)(nil), // 4: GetWalletInfoResponse
	(*LockBalanceRequest)(nil),    // 5: LockBalanceRequest
	(*LockBalanceResponse)(nil),   // 6: LockBalanceResponse
}
var file_balances_Common_proto_depIdxs = []int32{
	1, // 0: WalletInfo.balance_infos:type_name -> BalanceInfo
	2, // 1: GetWalletInfoResponse.wallet_info:type_name -> WalletInfo
...
func file_balances_Common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_balances_Common_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_balances_Common_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_balances_Common_proto_enumTypes,
